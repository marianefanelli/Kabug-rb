    ...
    stages{
        ...
        stage('Test'){
            steps{
                ...
                sh 'rm -f Gemfile.lock' //remove a file gemfile que estava associada a outra imagem q estavamos, como mudamos a imagem removemos essa gemfile.lock para que o jenkins crie outra para esta imagem
